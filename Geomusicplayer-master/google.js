	...
	data_layer.addListener('click', function(event) { 
				...
				if (artistObj.attributes.state === `${realState}`) {
					...
					artistDiv.addEventListener('click', function () {
						...
						<div class="artists-container" style="position: absolute; top: 74%; left: 3%; width: 100%, height: 30%">
							<div class="column" style="width: 33.33%; height: 33.33%; float: left;">
								<center><img src="/Users/aaronklotnia/Development/code/Mod-3-Project/geomusicology-api/app/assets/images/headers/taylor-swift.png" style="width: 90%; height: auto; border-radius: 50%;"/></center>
								<center><font color="#FFFFFF" style="font-size: 105%"><b>Taylor Swift</b></font></center>
							</div>
							<div class="column" style="width: 33.33%; height: 33.33%; float: left;">
								<center><img src="/Users/aaronklotnia/Development/code/Mod-3-Project/geomusicology-api/app/assets/images/artists/drdre-headshot.png" style="width: 90%; height: auto; border-radius: 50%;"/></center>
								<center><font color="#FFFFFF" style="font-size: 105%"><b>Dr. Dre</b></font></center>
							</div>
							<div class="column" style="width: 33.33%; height: 33.33%; float: left;">
								<center><img src="/Users/aaronklotnia/Development/code/Mod-3-Project/geomusicology-api/app/assets/images/headers/beyonce.png" style="width: 90%; height: auto; border-radius: 50%;"/></center>
				...
				designHistory.addEventListener('click', function (event) {
					...
					<div class="artist-body">
						...
						<style>
						  ...
						  <div class="artists-container" style="position: absolute; top: 74%; left: 3%; width: 100%, height: 30%">
						  <div class="column" style="width: 33.33%; height: 33.33%; float: left;">
						  <img class="artist-name" src="/Users/aaronklotnia/Development/code/Mod-3-Project/geomusicology-api/app/assets/images/headers/taylor-swift.png" style="width: 90%; height: auto; border-radius: 50%;"/>
						  <div class="artist-name"><center><font color="#FFFFFF" style="font-size: 105%"><b>Taylor Swift</b></font></center></div>
						  </div>
						  <div class="column" style="width: 33.33%; height: 33.33%; float: left;">
						  <img class="artist-name" src="/Users/aaronklotnia/Development/code/Mod-3-Project/geomusicology-api/app/assets/images/artists/drdre-headshot.png" style="width: 90%; height: auto; border-radius: 50%;"/>
						  <div class="artist-name"><center><font color="#FFFFFF" style="font-size: 105%"><b>Dr. Dre</b></font></center></div>
						  </div>
						  <div class="column" style="width: 33.33%; height: 33.33%; float: left;">
						  <img class="artist-name" src="/Users/aaronklotnia/Development/code/Mod-3-Project/geomusicology-api/app/assets/images/headers/beyonce.png" style="width: 90%; height: auto; border-radius: 50%;"/>
		...
		artists[event.feature.h.NAME].forEach(function (artist) {
			...
			artistDiv.addEventListener('click', function () {
				...
				// </style>
				// 	<div class="column" style="width: 33.33%; height: 33.33%; float: left;">
				// 		<div class="album" data-set="first-album"><img src="/Users/aaronklotnia/Development/code/Mod-3-Project/geomusicology-api/app/assets/images/albums/snoop-doggumentary.png" style="width: 90%; height: auto"/></div>
				// 		<font color="#FFFFFF" style="font-size: 105%"><b>Doggumentary</b></font><br>
				// 		<font color="#1ED761" style="font-size: 100%">2011</font><br>
				// 	</div>
				// 	<div class="column" style="width: 33.33%; height: 33.33%; float: left;">
				// 	<div class="album" data-set="second-album"><img src="/Users/aaronklotnia/Development/code/Mod-3-Project/geomusicology-api/app/assets/images/albums/snoop-doggfather.png" style="width: 90%; height: auto"/></div>
				// 		<font color="#FFFFFF" style="font-size: 105%"><b>Tha Doggfather</b></font><br>
				// 		<font color="#1ED761" style="font-size: 100%">1996</font><br>
				// 	</div>
				// 	<div class="column" style="width: 33.33%; height: 33.33%; float: left;">
				// 		<div class="album" data-set="third-album"><img src="/Users/aaronklotnia/Development/code/Mod-3-Project/geomusicology-api/app/assets/images/albums/snoop-doggy.png" style="width: 90%; height: auto"/></div>
				...
				// <div class="artists-container" style="position: absolute; top: 74%; left: 3%; width: 100%, height: 30%">
				// 	<div class="column" style="width: 33.33%; height: 33.33%; float: left;">
				// 		<img src="/Users/aaronklotnia/Development/code/Mod-3-Project/geomusicology-api/app/assets/images/artists/2pac-headshot.png" style="width: 90%; height: auto; border-radius: 50%;"/>
				// 		<center><font color="#FFFFFF" style="font-size: 105%"><b>2pac</b></font></center>
				// 	</div>
				// 	<div class="column" style="width: 33.33%; height: 33.33%; float: left;">
				// 		<img src="/Users/aaronklotnia/Development/code/Mod-3-Project/geomusicology-api/app/assets/images/artists/drdre-headshot.png" style="width: 90%; height: auto; border-radius: 50%;"/>
				// 		<center><font color="#FFFFFF" style="font-size: 105%"><b>Dr. Dre</b></font></center>
				// 	</div>
				// 	<div class="column" style="width: 33.33%; height: 33.33%; float: left;">
				// 		<img src="/Users/aaronklotnia/Development/code/Mod-3-Project/geomusicology-api/app/assets/images/artists/icecube-headshot.png" style="width: 90%; height: auto; border-radius: 50%;"/>
				...
				designHistory.addEventListener('click', function (event) {
					...
					<div class="artist-body">
						...
						.album:hover img{ 
						  ...
						  <div class="artists-container" style="position: absolute; top: 74%; left: 3%; width: 100%, height: 30%">
						  <div class="column" style="width: 33.33%; height: 33.33%; float: left;">
						  <img class="artist-name" src="/Users/aaronklotnia/Development/code/Mod-3-Project/geomusicology-api/app/assets/images/artists/2pac-headshot.png" style="width: 90%; height: auto; border-radius: 50%;"/>
						  ...
						  <div class="column" style="width: 33.33%; height: 33.33%; float: left;">
						  <img class="artist-name" src="/Users/aaronklotnia/Development/code/Mod-3-Project/geomusicology-api/app/assets/images/artists/icecube-headshot.png" style="width: 90%; height: auto; border-radius: 50%;"/>
